...
<div class="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Edit informasi laporan yang telah dibuat sebelumnya.</p>
        </div>

        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <form action="{{ route('owner.laporan.update', $laporan) }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-10">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label for="metode" class="block text-sm font-medium text-gray-700 mb-1">Metode Pengawasan</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    <a href="{{ route('owner.laporan.show', $laporan) }}"
                        class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                        Batal
                    </a>
                    <button type="submit"
                        class="inline-flex items-center px-6 py-3 border border-transparent rounded-xl text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Validasi keterangan tidak boleh mengandung tag HTML
        const form = document.querySelector('form');
        form.addEventListener('submit', function(e) {
            const ket = document.getElementById('keterangan').value;
            if (/<.*?>/.test(ket)) {
                alert('Keterangan tidak boleh mengandung tag HTML!');
                e.preventDefault();
            }
        });
    });
