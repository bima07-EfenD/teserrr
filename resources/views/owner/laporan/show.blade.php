    ...
    <div class="bg-gradient-to-br from-indigo-50 via-sky-50 to-white min-h-screen">
        <div class="max-w-7xl mx-auto pt-8 pb-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <a href="{{ route('owner.laporan.index') }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="h-5 w-5 mr-2 text-indigo-500 group-hover:-translate-x-1 transition-transform duration-200"
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <!-- Report info bar -->
                <div
                    class="bg-gray-50 border-b border-gray-100 px-8 py-4 flex flex-wrap md:flex-nowrap items-center justify-between gap-4">
