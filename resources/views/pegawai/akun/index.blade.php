    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="absolute -bottom-16 left-8">
                    <div class="relative">
                        <div id="fotoPreview" class="relative">
                            ...
                            @endif
                            <div id="uploadButton"
                                class="hidden absolute bottom-0 right-0 bg-white rounded-full p-2 shadow-lg hover:bg-gray-100 transition duration-200 cursor-pointer">
            ...
            <div class="pt-20 pb-8 px-8">
                ...
                <form id="editForm" action="{{ route('pegawai.akun.update') }}" method="POST"
